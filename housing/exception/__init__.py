...
class FlightfareException(Exception):
    ...
    def __init__(self, error_message:Exception,error_detail:sys)->str:
        ...
        self.error_message=error_message=FlightfareException.get_detailed_error_message(error_message=error_message,error_detail=error_detail)
    ...
    def __repr__(self) -> str:
        return FlightfareException.__name__.str()                                                                    